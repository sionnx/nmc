import { cacheSearchKeyword, processSearchResult, processSearchSongResult } from "./processes/process_search_result";
...
async function processResponse() {
  ...
  if ($response && $response.body !== undefined && $response.body !== null) {
    ...
    processSearchResult(decryptedBody);
    processSearchSongResult(decryptedBody);
